...
app = Flask(__name__)
app.url_map.strict_slashes = False  # avoid spurious 404s on trailing-slash variants
...
@app.route("/.well-known/agent-card.json", methods=["GET"], strict_slashes=False)
@app.route("/a2a/.well-known/agent-card.json", methods=["GET"], strict_slashes=False)
def agent_card():
